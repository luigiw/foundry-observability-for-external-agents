...
CLIENT_SERVICE_NAME = "customer-support-client-gcp"
...
def invoke_agent(message: str, customer_id: str | None = None) -> dict:
    ...
    so the server-side spans appear as children of this invocation.
    """
    ...
    with tracer.start_as_current_span(
        ...
        attributes={
            "peer.service": "gcp-langgraph-customer-support",
            "http.method": "POST",
